      ...
      <div class="container">
        <form action="{{ route('student.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row mt-3">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="colFormLabel" name='name' placeholder="Student name">
              </div>
            </div>
            <div class="form-group row mt-3">
            ...
            <div class="form-group row mt-3">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="colFormLabel" placeholder="" name="phone">
              </div>
            </div>
            <div class="form-group row mt-3">
            ...
            <div class="form-group row mt-3">
              ...
              <div class="col-sm-10">
                <input type="number" min="1900" max="2022" step="1" value="2020" name="education_year"/>
              </div>
            </div>
            <div class="form-group row mt-3">
